...
/*
This api is used for handling requests in "apipublish" router

@param $userDetails- user details,$callback- send error or response back to caller 
$setcookie- cookie ,$apiDetalis- api details
...
var amapipublish=function(){
    ...
    */
    ...
    /** 
    * @desc handles a adding API request 
    */
    ...
    /** 
    * @desc handles a publishing an API request 
    */
